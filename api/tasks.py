...
def _build_email_body(customer_name: str, reasons_text: str) -> str:
    ...
    lines = [
        f"Hello {name},",
        "",
        "ChurnIQ has identified this customer account as high risk.",
        "",
    ...
    lines += [
        ...
        "",
        "This message was generated by ChurnIQ."
    ]
    return "\n".join(lines)
...
def send_retention_email_task(self, customer_id: int, task_id: int):
    ...
    try:
        ...
        # otherwise use the customer's real email, or a placeholder
